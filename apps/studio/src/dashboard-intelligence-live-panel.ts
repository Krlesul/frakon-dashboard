...
export class FrakonDashboardIntelligenceLivePanel extends LitElement {
  ...
  private onAuditEntityAction(event: CustomEvent<FrakonDashboardEmergencyEntityActionDetail>): void {
    const entityId = event.detail.entityId.trim();
