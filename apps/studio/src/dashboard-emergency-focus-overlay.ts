...
export class FrakonDashboardEmergencyFocusOverlay extends LitElement {
  ...
  static styles = css`
    ...
    .label { position:absolute; left:8px; top:8px; display:grid; gap:2px; max-width:calc(100% - 16px); padding:7px 9px; border-radius:8px; color:white; background:rgb(151 19 31 / 94%); font:700 10px/1.25 Inter,system-ui,sans-serif; }
