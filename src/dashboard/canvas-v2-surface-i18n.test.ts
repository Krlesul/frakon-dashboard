...
const keys: CanvasV2SurfaceTranslationKey[] = ['surface','selected','dashboard','cardDefaults','selection','fill','border','radius','padding','background','opacity','blur','borderWidth','borderColor','gradient','imageUrl','shadow','inheritDefaults','resetDefaults','theme','borderless','transparent','solid','glass','image','none'];
...
describe('canvas v2 surface translations', () => {
  ...
  it('contains localized Czech editor labels', () => {
    ...
    expect(canvasV2SurfaceTranslate('cs','dashboard')).toBe('Dashboard');
