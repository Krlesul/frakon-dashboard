...
const keys: CanvasV2SurfaceTranslationKey[] = ['surface','selected','cardDefaults','selection','fill','border','radius','padding','background','opacity','blur','borderWidth','borderColor','gradient','imageUrl','shadow','inheritDefaults','resetDefaults','theme','transparent','solid','glass','image','none'];
