...
export const frakonCardCatalog: readonly FrakonCardTemplate[] = [
  ...
  { type:'custom:frakon-light-card', name:'Light', description:'Light control with brightness.', category:'lighting', defaultWidth:3, defaultHeight:4, createConfig:(entity='light.placeholder')=>({ type:'custom:frakon-light-card', entity, show_brightness:true }) },
