...
export const frakonCardCatalog: readonly FrakonCardTemplate[] = [
  ...
  { type:'custom:frakon-lock-card', name:'Lock', description:'Lock and unlock control with state feedback.', category:'security', defaultWidth:3, defaultHeight:3, createConfig:(entity='lock.placeholder')=>({ type:'custom:frakon-lock-card', entity, show_state:true }) },
