...
const messages: Record<SupportedLanguage, Messages> = {
  ...
  cs: {
    title: 'Připravenost responsive zápisu', clean: 'Žádné lokální změny', dirty: 'Lokální změny', ready: 'Připraveno k uložení', blocked: 'Uložení zablokováno', save: 'Uložit responsive rozložení', validateOnServer: 'Ověřit na serveru', validationValid: 'Serverová validace prošla — úložiště se nezměnilo', validationConflict: 'Serverová validace našla novější vzdálenou revizi', validationBlocked: 'Serverová validace není dostupná', validationRequired: 'Před uložením ověřte na serveru přesně tuto kandidátní revizi', baseRevision: 'Výchozí revize', candidateRevision: 'Kandidátní revize', dirtyBreakpoints: 'Změněné breakpointy', noDirtyBreakpoints: 'žádné',
  ...
  pl: {
    title: 'Gotowość zapisu responsywnego', clean: 'Brak lokalnych zmian', dirty: 'Zmiany lokalne', ready: 'Gotowe do zapisu', blocked: 'Zapis zablokowany', save: 'Zapisz układ responsywny', validateOnServer: 'Sprawdź na serwerze', validationValid: 'Walidacja serwera powiodła się — magazyn nie został zmieniony', validationConflict: 'Walidacja serwera wykryła nowszą zdalną rewizję', validationBlocked: 'Walidacja serwera jest niedostępna', validationRequired: 'Przed zapisem sprawdź na serwerze dokładnie tę rewizję kandydującą', baseRevision: 'Rewizja bazowa', candidateRevision: 'Rewizja kandydująca', dirtyBreakpoints: 'Zmienione breakpointy', noDirtyBreakpoints: 'brak',
