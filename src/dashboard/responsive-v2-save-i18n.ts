...
export type ResponsiveV2SaveTranslationKey =
  ...
  | 'validationValid' | 'validationConflict' | 'validationBlocked' | 'validationRequired'
  | 'serverValidatedRevision' | 'validated' | 'notValidated'
...
const messages: Record<SupportedLanguage, Messages> = {
  en: {
    title: 'Responsive save readiness', clean: 'No local changes', dirty: 'Local changes', ready: 'Ready to save', blocked: 'Save blocked', save: 'Save responsive layout', validateOnServer: 'Validate on server', validationValid: 'Server validation passed — no storage was changed', validationConflict: 'Server validation found a newer remote revision', validationBlocked: 'Server validation is unavailable', validationRequired: 'Validate this exact candidate on the server before saving', serverValidatedRevision: 'Server validated revision', validated: 'validated', notValidated: 'not validated', baseRevision: 'Base revision', candidateRevision: 'Candidate revision', dirtyBreakpoints: 'Changed breakpoints', noDirtyBreakpoints: 'none',
  ...
  cs: {
    title: 'Připravenost responsive zápisu', clean: 'Žádné lokální změny', dirty: 'Lokální změny', ready: 'Připraveno k uložení', blocked: 'Uložení zablokováno', save: 'Uložit responsive rozložení', validateOnServer: 'Ověřit na serveru', validationValid: 'Serverová validace prošla — úložiště se nezměnilo', validationConflict: 'Serverová validace našla novější vzdálenou revizi', validationBlocked: 'Serverová validace není dostupná', validationRequired: 'Před uložením ověřte na serveru přesně tuto kandidátní revizi', serverValidatedRevision: 'Serverem ověřená revize', validated: 'ověřeno', notValidated: 'neověřeno', baseRevision: 'Výchozí revize', candidateRevision: 'Kandidátní revize', dirtyBreakpoints: 'Změněné breakpointy', noDirtyBreakpoints: 'žádné',
  ...
  pl: {
    title: 'Gotowość zapisu responsywnego', clean: 'Brak lokalnych zmian', dirty: 'Zmiany lokalne', ready: 'Gotowe do zapisu', blocked: 'Zapis zablokowany', save: 'Zapisz układ responsywny', validateOnServer: 'Sprawdź na serwerze', validationValid: 'Walidacja serwera powiodła się — magazyn nie został zmieniony', validationConflict: 'Walidacja serwera wykryła nowszą zdalną rewizję', validationBlocked: 'Walidacja serwera jest niedostępna', validationRequired: 'Przed zapisem sprawdź na serwerze dokładnie tę rewizję kandydującą', serverValidatedRevision: 'Rewizja zweryfikowana przez serwer', validated: 'zweryfikowano', notValidated: 'niezweryfikowano', baseRevision: 'Rewizja bazowa', candidateRevision: 'Rewizja kandydująca', dirtyBreakpoints: 'Zmienione breakpointy', noDirtyBreakpoints: 'brak',
