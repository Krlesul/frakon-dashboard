...
const messages: Record<SupportedLanguage, Messages> = {
  en: {
    ...
    v2ReadReady: 'v2 read ready', v2ReadBlocked: 'v2 read blocked', v2WriteReady: 'v2 write ready', v2WriteBlocked: 'v2 write blocked',
  ...
  cs: {
    ...
    v2ReadReady: 'čtení v2 připraveno', v2ReadBlocked: 'čtení v2 blokováno', v2WriteReady: 'zápis v2 připraven', v2WriteBlocked: 'zápis v2 blokován',
  ...
  de: {
    ...
    v2ReadReady: 'v2 Lesen bereit', v2ReadBlocked: 'v2 Lesen blockiert', v2WriteReady: 'v2 Schreiben bereit', v2WriteBlocked: 'v2 Schreiben blockiert',
  ...
  sk: {
    ...
    v2ReadReady: 'čítanie v2 pripravené', v2ReadBlocked: 'čítanie v2 blokované', v2WriteReady: 'zápis v2 pripravený', v2WriteBlocked: 'zápis v2 blokovaný',
  ...
  pl: {
    ...
    v2ReadReady: 'odczyt v2 gotowy', v2ReadBlocked: 'odczyt v2 zablokowany', v2WriteReady: 'zapis v2 gotowy', v2WriteBlocked: 'zapis v2 zablokowany',
