...
window.customCards.push(
  ...
  { type: 'frakon-dashboard-card', name: 'FRAKON Dashboard Card', description: 'Editable responsive grid with persistence and visual editor.', preview: true },
);

console.info('%c FRAKON Dashboard %c 0.7.0-alpha.1 ', 'background:#10141c;color:#fff;padding:4px 8px;border-radius:6px 0 0 6px', 'background:#6aa8ff;color:#07101d;padding:4px 8px;border-radius:0 6px 6px 0');
